...
class PageSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      DB::table('pages')->insert([
        'title'=>$page,
        'slug'=>Str::slug($page),
        'image'=>'https://cdn.brandfolder.io/XG3NESCC/at/7w3n3bbh84w7h2z5bcp443/circuit-board-header.jpg?quality=85',
        ...
        cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet,       consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
         ...
         r in reprehenderit in voluptate velit esse crunt mollit anim id est laborum.',
         'order'=>$count,
        'created_at'=>now(),
        'updated_at'=>now()
        ]);
