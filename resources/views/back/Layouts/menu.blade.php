    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Blog Admin Panel</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2)=="makaleler") show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Articles Cruds:</h6>
                        <a class="collapse-item @if(Request::segment(2)=="makaleler" and !Request::segment(3)) active  @endif" href="{{route('admin.makaleler.index')}}">All Articles </a>
                        <a class="collapse-item @if(Request::segment(3)=="create") active  @endif" href="{{route('admin.makaleler.create')}}">Create New Articles</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" @if(Request::segment(2)=="kategoriler") active  @endif href="{{route('admin.kategoriler')}}"  >
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('homepage')}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-blog fa-sm text-white-50"></i> Generate Report</a>
                    </div>
